            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
              <div class="auth-form-transparent text-left p-3">
                ...
                <form class="pt-3">
                  ...
                  <div class="mt-3">
                    <a class="btn d-grid btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">SIGN UP</a>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Already have an account? <nuxt-link to="/" class="text-primary font-weight-bold">Login</nuxt-link>
                  </div>
                </form>
              </div>
            </div>
