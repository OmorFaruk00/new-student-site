<template>
  <div class="row bg-image">
    <div class="no-print">
      <form class="form-horizontal rounded p-4 mb-4" id="findBatchMateResultForm"
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
      <div class="result transcriptPrint rounded" v-if="results.student_info.name && !isloading" id="transcriptPrint">
        <div class="header">
          <div class="title">
...
course, courseIndex
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 mb-1">
      ...
      <div class="result rounded pb-3" v-if="batch_mate_results.student_info.name && !loading">
