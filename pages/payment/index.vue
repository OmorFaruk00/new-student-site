                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="mobile-tab" data-bs-toggle="tab" href="#mobile" role="tab"
                                aria-controls="home" aria-selected="true">Mobile Banking</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade show active" id="mobile" role="tabpanel" aria-labelledby="mobile-tab">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12 py-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" v-model="bkash_amount" required
                                            placeholder="Amount">
                                    </div>
                                    <div class="pb-5 float-end">
                                        <button :disabled="bloading" type="submit" class="btn btn-primary"
                                            @click="paymentBkash">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-3 col-sm-12">
                                    <div class="pay-card p-3 mb-3  mx-auto">
                                        <img src="https://nagad.com.bd/_nuxt/img/logo.a4624c6.svg" alt=""
                                            class="pay-img">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-9 col-sm-12 py-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" v-model="nagad_amount" required
                                            placeholder="Amount">
                                    </div>
                                    <div class="pb-5 float-end">
                                        <button :disabled="nloading" type="submit" class="btn btn-primary"
                                            @click="paymentNagad">
                        ...
                        <div class="tab-pane fade" id="edit-mobile" role="tabpanel" aria-labelledby="credit-card">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 py-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" v-model="card_amount" required
                                            placeholder="Amount">
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 text-end">
                                            <button :disabled="cloading" type="submit" class="btn btn-primary"
                                                @click="paymentCard">
